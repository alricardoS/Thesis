...
RUNNER_SCRIPT="$BASE_DIR/run_multi_sta_priority_experiments_per_sta.sh"
...
RESULTS_ROOT_DIR="${RESULTS_ROOT_DIR:-$BASE_DIR/results_multi_sta_priority_suite_per_sta}"
...
# ==============================
EXPERIMENTS=(
  "one_vi_onebe_two_vo|voice,voice,besteffort,video"
